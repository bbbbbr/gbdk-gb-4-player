...
const uint8_t fade_steps_dmg_OBP0[] = {
    DMG_PALETTE(DMG_DARK_GRAY, DMG_WHITE,     DMG_LITE_GRAY, DMG_BLACK),
    DMG_PALETTE(DMG_BLACK,     DMG_LITE_GRAY, DMG_DARK_GRAY, DMG_BLACK),
    DMG_PALETTE(DMG_BLACK,     DMG_DARK_GRAY, DMG_BLACK,     DMG_BLACK),
    DMG_PALETTE(DMG_BLACK,     DMG_BLACK,     DMG_BLACK,     DMG_BLACK)
};
